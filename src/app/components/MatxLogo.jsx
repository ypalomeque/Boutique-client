...
import { BASE_URL_DEV, BASE_URL_PROD } from "app/utils/constant";
...
export default function MatxLogo({ className }) {
  ...
  return (
    ...
    //     </g>
    //   </g>
    // </svg>`${BASE_URL_DEV}archivo/img2023_10-01_no-log-base_login}`
    ...
    //         generalConfigurations?.length > 0 && generalConfigurations[0].logo
    //       }`
    //     : `${BASE_URL_DEV}archivo/img2023_10-01_no-log-base_login.jpg}`
    // }
