...
const Pagination = ({ page, setPage, maximum }) => {
  ...
  return (
    <div className={styles.container}>
      <button disabled={page === 1 || page < 1} onClick={previousPage} className="tooltip1">
        <span class="tooltip-content" style={{ fontSize: "8px", marginTop: "4%" }}>
          A tras
        </span>
      ...
      <Grid md={2}>
        <input
          className="form-control-input-ppal input"
      ...
      <p style={{ margin: "auto 0px" }}> de {maximum} </p>
      <button
        className="tooltip1"
